...
class RegisterValidation {
    ...
    public function messages() {
        return [
            ...
            'password.min' => 'Votre mot de passe doit faire au minimum 8 cractères !',
            'confirm_password.same' =>'Votre mot de passe et votre mot de passe de confirmation doivent être identitque'
        ];
    }
}